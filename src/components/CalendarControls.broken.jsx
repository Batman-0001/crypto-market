...
const CalendarControls = ({
  ...
  // GSAP Animations - Fixed to not interfere with rendering
  useEffect(() => {
    if (containerRef.current) {
      ...
      // Stagger animation for cards - only if cards exist
  ...
  // Collapse animation - Fixed to not interfere with rendering
  useEffect(() => {
  ...
  // Card hover animations - Simplified to prevent rendering issues
